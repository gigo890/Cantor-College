...
<head>
    ...
    <meta name="Description" content="Rules governing the use of the resource services">
    <title>Document</title>
</head>
<body>
    <?php include("header.php")?>
    <div class="banner" id="learning-resources">
    ...
    <h1>Rules Governing the Use of the Resource Services</h1>
        <div class="info">
            ...
            <div class="list" id="learning-resources">
                <h2>Rules</h2>
                <ul>
                    <li><h3>Access</h3></li>
                    <ul>
                        ...
                        <li> Users of the Learning Resources are reminded that they must be willing to show  ID cards or other identification when requested to do so by College staff.</li>

                    </ul>
                    <li><h3>Use of Facilities</h3></li>
                    <ul>
